...
<body>
  ...
  <th style="text-align: center;">Remark</th>
    ...
    <?php
      ...
      <td style="text-align: center;"><a target="_blank" href="./updateconsole.php?id=<?php echo $row['id']?>">update</a></td>
      <td style="text-align: center;"><a target="_blank" href="./mail.php?id=<?php echo $row['id']?>">Send</a></td>
    </tr>
       <?php }}} 
