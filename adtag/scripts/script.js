...
function showRecordsForAdmin(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    table += `${arr[i]["status_v"] === "staging" ? '<tr style="display:none">' : '<tr>'}
...
function showRecordsForHC(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    table += `<tr>
      ...
      <td style="text-align: center;"><a target="_blank" href="./updateconsole.php?id=${arr[i]["id"]}">update</a></td>
      <td style="text-align: center;"><a target="_blank" href="./mail.php?id=${arr[i]["id"]}">Send</a></td>
    </tr>`;
  }
  table += `</table>`;
  document.getElementById("table").innerHTML = table;
...
function showRecordsForVeena(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    table += `<tr>
      ...
      <td style="text-align: center;">
        ...
        <td style="text-align: center;">
        <select name="status_v" id="status_v-${arr[i]["id"]}">
  ...
  document.getElementById("table").innerHTML = table;
  for (let i = 0; i < arr.length; i++) {
    document.getElementById("status_v-"+ arr[i]["id"]).value = arr[i]["status_v"];
  }
}
...
function updateRemark(id) {
  ...
  if (team === "Garud" || team === "Nischay" || team === "lakshay") {
    let textarea = document.getElementById(id);
    formdata["id"] = id;
    formdata["remark"] = textarea.value;
    formdata["status_v"] = "staging";
  } else if (team === "Veena") {
    let status = document.getElementById("status_v-" +id);
    // console.log(status);
    let textarea = document.getElementById(id);
