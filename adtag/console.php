...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `adtagdata`(`fcat_n`,`create_time`,`developer_name`,`adtag_type`, `geo`, `campaign_name`, `master_client` ,`client`, `fcat`, `publisher`, `dims`, `status`,`status_v`) VALUES ('$fcat_n','$time','$dev_name','$adtag_type','$geo','$campaign_name', '$master_client' ,'$client','$fcat','$publisher','$dims','staging','staging')";
...
<body>
    <div id="box">
        <form action="" method="post" >
            ...
            <input type="checkbox" id="fcat_nan" name="fcat_n" value="fcat_nan" onclick="disable()">
    ...
    <script>
        function disable(){
            ...
            document.getElementById("typ1").disabled=false;
